...
export default function Home() {
  ...
  // ★ Googleアナリティクスに画面切り替え（Viewの変化）を通知する
  useEffect(() => {
  ...
  const saveScenario = async () => {
    ...
    const dbData = { 
      ...
      prologue: editingScenario.prologue || "", epilogue: editingScenario.epilogue || "",
    ...
    try {
      ...
      if (targetTab === "story") {
        roleInstructionLines = [
          ...
          "目的達成後は必ず「【エピローグ】」と明記し、これまでの展開（グッドエンドかバッドエンドか等）を踏まえて相応しい結末を動的に生成し、事後処理や仲間・NPCとの最後の会話を行うフェーズに入ってください。",
