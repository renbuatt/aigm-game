    ...
    <main className="h-screen w-full bg-slate-900 text-slate-100 flex flex-col font-sans overflow-hidden">
      ...
      {currentView === "admin" && currentUser?.isAdmin && (
        <AdminView
          ...
          adminExecuteBan={adminExecuteBan} 
          adminUnbanUser={adminUnbanUser} 
          adminSuspendUser={adminSuspendUser} 
          adminUnsuspendUser={adminUnsuspendUser} 
          adminExecuteScenarioBan={adminExecuteScenarioBan} 
          adminUnbanScenario={adminUnbanScenario} 
          adminDeleteScenario={adminDeleteScenario} 
          setCurrentView={setCurrentView} 
          executeCreateTester={executeCreateTester} 
          grantPointsToAll={grantPointsToAll} 
