...
【電話番号】
04-7144-9425
※サービスに関するお問い合わせは、記録保持のため原則としてお問い合わせフォーム（メール）よりお願いいたします。

【販売価格】
各商品・チケットの購入ページに税込み価格を表示しております。

【支払方法・時期】
・クレジットカード：購入時に決済が行われます。引き落とし日は各カード会社の規定によります。
・PayPay：購入時に即時決済されます。

【引き渡し時期】
・ゲーム使用権：購入後、即時アカウントに付与・反映されます。
・アイテム購入権：購入後、即時アカウントに反映されます。
